...
it('should check if ends with question mark ?', function () {
    ...
    ])->assertSessionHasErrors(['question' => 'Are you sure that is a question? It is missing the question mark in the end.']);
...
it('should have at least 10 characters', function () {
    ...
    ])->assertSessionHasErrors(['question' => __('validation.min.string', ['min' => 10, 'attribute' => 'question'])]);
